...
import { externalAccountRoutes } from "./external-accounts";
...
import { mobileDeviceRoutes, mobileRoutes } from "./mobile";
...
api.route("/mobile", mobileDeviceRoutes);
...
api.use("/external-accounts/*", requireAuth);
...
api.route("/external-accounts", externalAccountRoutes);
