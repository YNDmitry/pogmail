/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker/worker-configuration.d.ts` (hash: 672031099bf14b93fa6fee2e9d7819e1)
...
interface __BaseEnv_Env {
	...
	REALTIME: DurableObjectNamespace<import("./index").RealtimeHub>;
	BACKUP_WORKFLOW: Workflow<Parameters<import("./index").DatabaseBackupWorkflow['run']>[0]['payload']>;
	RESTORE_WORKFLOW: Workflow<Parameters<import("./index").DatabaseRestoreWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANDROID_APP_PACKAGE" | "ANDROID_APP_SHA256_CERT_FINGERPRINTS" | "DEV_MOCK_CLOUDFLARE">> {}
}
